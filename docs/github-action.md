...
| `version` | no | `v1.8.12` | Release tag/branch to clone (ignored if `local-source` set) |
...
This repository is the action (`action.yml` at root). Tag releases (`v1.8.12`) so consumers can pin `@v1.8.12` or `@v1`.
