...
| `version` | no | `v1.9.8` | Release tag/branch to clone (ignored if `local-source` set) |
...
This repository is the action (`action.yml` at root). Tag releases (`v1.9.8`) so consumers can pin `@v1.9.8` or `@v1`.
