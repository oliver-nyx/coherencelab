...
| `version` | no | `v1.7.2` | Release tag/branch to clone (ignored if `local-source` set) |
...
This repository is the action (`action.yml` at root). Tag releases (`v1.7.2`) so consumers can pin `@v1.7.2` or `@v1`.
