...
var Catalog = []Fixture{
	...
	{Name: "h3_firefox", Kind: "h3", File: "h3-firefox-live.bin",
		Source: "live-browser", Notes: "Real Firefox H3 control stream via serve HTTP/3 (Windows); SETTINGS(+Mozilla ids)+GREASE frame; no PRIORITY_UPDATE on live control stream (first flight and tab-focus attempts) — needs disable_when_third_party_roots_found=false for local CA"},
