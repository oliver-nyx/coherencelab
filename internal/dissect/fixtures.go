...
var Catalog = []Fixture{
	...
	{Name: "h2_chrome", Kind: "h2", File: "h2-chrome-live.bin",
		Source: "live-browser", Notes: "Real Chrome H2 preface+SETTINGS+WINDOW_UPDATE via coherencelab serve (Windows); Akamai field 3=0 on first probe flight"},
	{Name: "h2_edge", Kind: "h2", File: "h2-edge-live.bin",
		Source: "live-browser", Notes: "Real Edge H2 preface+SETTINGS+WINDOW_UPDATE via coherencelab serve (Windows)"},
	...
	{Name: "h2_firefox", Kind: "h2", File: "h2-firefox-like.bin",
		Source: "crafted", Notes: "Firefox-like SETTINGS+HEADERS m,p,a,s — live Firefox H2 needs trusted probe cert (ClientHello-only on self-signed)"},
	{Name: "h3_chrome", Kind: "h3", File: "h3-chrome-like.bin",
		Source: "crafted", Notes: "H3 SETTINGS(+GREASE)+GREASE frame+PRIORITY_UPDATE+QPACK HEADERS — post-decrypt teaching fixture (live H3 needs full H3 server)"},
